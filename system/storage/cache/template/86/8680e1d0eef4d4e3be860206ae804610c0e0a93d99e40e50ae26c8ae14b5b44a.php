...
/* ft_frame/template/extension/module/category.twig */
class __TwigTemplate_3cea200c5105d21c67690c9594216b085dadcbfcea319cd5ec9659c07bd98ae5 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["category"], "category_id", [], "any", false, false, false, 3) == ($context["category_id"] ?? null))) {
                ...
                echo "\" class=\"list-group-item list-group-item-action active py-2\">";
  ...
  ";
                            ...
                            echo "\" class=\"list-group-item list-group-item-action py-2\">&nbsp;&nbsp;&nbsp;- ";
...
";
    ...
    {
        return "ft_frame/template/extension/module/category.twig";
    }
    ...
    {
        return new Source("", "ft_frame/template/extension/module/category.twig", "");
    }
}
